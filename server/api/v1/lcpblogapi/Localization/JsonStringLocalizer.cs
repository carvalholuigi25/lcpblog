...
namespace lcpblogapi.Localization;
...
public class JsonStringLocalizer : IStringLocalizer
{
    ...
    {
        var fslash = MyFunctions.GetSlash();
        var respath = $"{Path.GetDirectoryName(Directory.GetCurrentDirectory())}{fslash}lcpblogapi.library{fslash}Resources{fslash}";
