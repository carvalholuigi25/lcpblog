    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            await axios({
                ...
                setTimeout(() => {
                    alert("The news post has been added with succesfully!");
                    push("/");
                }, 1000 / 2);
            }).catch((err) => {
                console.error(err);
                ...
                <>
                    ...
                    <form className={styles.frmaddnews}>
                        ...
                        <div className="d-inline-block mx-auto mt-3">
                            ...
                            <button className="btn btn-primary btnlog btn-rounded ms-3" type="button" onClick={handleSubmit} disabled={isSubmitting}>Create</button>
                        </div>
                    </form>
