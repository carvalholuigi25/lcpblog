...
import { fregstep3Schema, TFormRegDataStep3 } from "@/app/schemas/formSchemas";
    ...
    <div>
      <form className={styles.frmregstep} onSubmit={handleSubmit(onSubmit)}>
        <div className={styles.sregistertitlefrm}>
          <h3 className={styles.sregistertitlefrmtxt + " text-center"}>Step 3: Final steps</h3>
        </div>

        <div className="form-group mt-3 text-center">
          <label htmlFor="termsandcon">Terms and conditions</label>
          ...
          <div className="d-flex flex-row justify-content-center align-items-center mt-3">
            ...
            <label htmlFor="termsandcond" className={"termsandcondtxt " + styles.sregistertermstxt}>I read and agree all the terms and conditions</label>
          </div>
        ...
        <div className="d-inline-block mx-auto mt-3">
          <button className="btn btn-primary btnreset btn-rounded" type="button" onClick={onClear}>Reset</button>
          <button className="btn btn-primary btnprev btn-rounded ms-3" type="button" onClick={onBack}>Previous</button>
          <button className="btn btn-primary btnreg btn-rounded ms-3" type="submit" disabled={isSubmitting}>Register</button>
        </div>
      </form>
    </div>
  );
