...
import DeleteVideosForm from "@applocale/components/ui/forms/crud/videos/delete/delete";

const AdminDeleteVideos = () => {
                                ...
                                <div className="container mt-3">
                                    <div className="row">
                                        <div className="col-12">
                                            <DeleteVideosForm mediaId={parseInt(""+mediaId)} data={videos} />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default withAuth(AdminDeleteVideos, onlyAdmins);