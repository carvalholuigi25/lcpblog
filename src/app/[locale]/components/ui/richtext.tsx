...
type Tag = 'emailAuthor' | 'websiteAuthor' | 'p' | 'b' | 'i' | 'a' | 'ol' | 'ul' | 'li' | 'br' | 'list1' | 'list2' | 'list3' | 'list4' | 'list5' | 'list6' | 'list7' | 'list8' | 'list9' | 'list10' | 'list11' | 'list12' | 'liststr1' | 'liststr2' | 'liststr3' | 'thead' | 'tbody' | 'tfoot' | 'tr' | 'th' | 'td' | 'tableres';
...
export const ListTags = () => {
  return {
    emailAuthor: (chunks: ReactNode) => <a href={"mailto:luiscarvalho239@gmail.com"} target="_blank">{chunks}</a>,
    websiteAuthor: (chunks: ReactNode) => <a href={"http://localhost:3000"} target='_blank'>{chunks}</a>,
