...
const schema = z.object({
  ...
  sortby: z.enum(["tagId", "title"]),
});

type SearchFormData = z.infer<typeof schema>;

export default function AdvancedSearchTags({ isSearchEnabled, pageIndex, pageSize }: any) {
  const t = useTranslations("ui.forms.advancedsearch.tags");
  ...
  const {
    ...
    defaultValues: {
      ...
      sortby: (searchParams.get("sortby") as "tagId" | "title") ?? "tagId",
    },
  });
  ...
  const resetSearch = () => {
    ...
    url.searchParams.set("sortby", "tagId");
    window.history.pushState({}, '', url.toString());
  };
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6">
              <div className="form-group mt-3">
                ...
                >
                  <option value="tagId">{t("optssortby.tagId") ?? "Tag Id"}</option>
